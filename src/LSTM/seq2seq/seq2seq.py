...
def main():
    ...
    tokenizer.save("weights/tokenizer_v1.pt")

    print('Training encoder and decoder...')    

    encoder = Encoder(vocab_size = VOCAB_SIZE + 2, embedding_dim = 256, hidden_dim = 512)
    decoder = Decoder(vocab_size = VOCAB_SIZE + 2, embedding_dim = 256, hidden_dim = 512, attention_dim=ATTENTION_DIMS)
    ...
    encoder.save_weights('weights/encoder_v3.pt')
    decoder.save_weights('weights/decoder_v3.pt')
    print("Weights saved!")
